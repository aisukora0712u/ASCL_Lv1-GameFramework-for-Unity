...
namespace ASCL.Unity {
    ...
    public sealed class NumericCatalogSO:ScriptableObject {
        [Serializable]private struct Entry{public string name;public int id;public float defaultValue;public bool hasMinimum;public float minimum;public bool hasMaximum;public float maximum;}
