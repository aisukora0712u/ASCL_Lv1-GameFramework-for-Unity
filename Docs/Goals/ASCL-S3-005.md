...
# ASCL-S3-005 · 最小对抗与命中延迟补偿

## 问题与预期收益

当前基线尚未完成本目标的正式验收。通过最小对抗与命中延迟补偿沉淀可跨项目复用、可观察和可验证的能力。
...
最小对抗下校验历史目标查询和有效时间范围；区别插值/预测/回滚/命中补偿；非法历史时间不能获得额外命中。
